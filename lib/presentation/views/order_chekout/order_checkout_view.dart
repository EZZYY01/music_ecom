...
import 'package:soundsage/core/extension/string_extension.dart';
import 'package:soundsage/presentation/blocs/cart/cart_bloc.dart';
import 'package:soundsage/presentation/blocs/home/navbar_cubit.dart';
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                                "\NRS.${items.fold(0.0, (previousValue, element) => (element.priceTag.price + previousValue))}")
                          ],
                        ),
                        const Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [Text("Delivery Charge"), Text("NRS.4.99")],
                        ),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            const Text("Total"),
                            Text(
                                "\NRS.${(items.fold(0.0, (previousValue, element) => (element.priceTag.price + previousValue)) + 4.99)}")
                          ],
                        )
                      ],
                    ),
